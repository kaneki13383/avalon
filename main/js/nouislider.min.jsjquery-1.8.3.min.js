...
!function(t) {
    ...
    function z(t, v, o) {
        var l, u, s, c, i, a, e, p, f = window.navigator.pointerEnabled ? {
            ...
            return t
        }(), h = t, y = v.spectrum, x = [], b = [], m = [], g = 0, S = {}, w = t.ownerDocument, E = v.documentElement || w.documentElement, C = w.body, N = -1, P = 0, U = 1, A = 2, V = "rtl" === w.dir || 1 === v.ort ? 0 : 100;
        function k(t, e) {
        ...
        function D(t, e) {
            ...
            return k(n, v.cssClasses.touchArea),
            ...
            n.addEventListener("keydown", function(t) {
                return function(t, e) {
                    ...
                    p || c) {
                        ...
                        s = d ? v.spectrum.xVal[v.spectrum.xVal.length - 1] : v.spectrum.xVal[0];
        ...
        function j(e, i, o) {
            ...
            return ht(s, v.cssClasses.pips),
            ht(s, 0 === v.ort ? v.cssClasses.pipsHorizontal : v.cssClasses.pipsVertical),
            Object.keys(e).forEach(function(t) {
                !function(t, e, r) {
                    if ((r = i ? i(e, r) : r) !== N) {
                        ...
                        n.style[v.style] = t + "%",
                        P < r && ((n = k(s, !1)).className = p(r, v.cssClasses.value),
        ...
        function R(t) {
            F();
            var m, g, v, x, e, r, b, S, w, n = t.mode, i = t.density || 1, o = t.filter || !1, s = function(t, e, r) {
                if ("range" === t || "steps" === t)
                    return y.xVal;
                if ("count" === t) {
                    if (e < 2)
        ...
        function K(t, e, r, n, i, o) {
            var s;
            return 1 < u.length && !v.events.unconstrained && (n && 0 < e && (s = y.getAbsoluteDistance(t[e - 1], v.margin, 0),
            r = Math.max(r, s)),
            i && e < u.length - 1 && (s = y.getAbsoluteDistance(t[e + 1], v.margin, 1),
            r = Math.min(r, s))),
            1 < u.length && v.limit && (n && 0 < e && (s = y.getAbsoluteDistance(t[e - 1], v.limit, 0),
            r = Math.min(r, s)),
            i && e < u.length - 1 && (s = y.getAbsoluteDistance(t[e + 1], v.limit, 1),
            r = Math.max(r, s))),
            v.padding && (0 === e && (s = y.getAbsoluteDistance(0, v.padding[0], 0),
            r = Math.max(r, s)),
            e === u.length - 1 && (s = y.getAbsoluteDistance(100, v.padding[1], 1),
            r = Math.min(r, s))),
        ...
        ht(e, "rtl" === getComputedStyle(e).direction ? v.cssClasses.textDirectionRtl : v.cssClasses.textDirectionLtr),
